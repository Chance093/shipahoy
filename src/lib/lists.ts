...
export const formInputs = [
  ...
  { id: 33, label: "Address", property: "FromStreet1", required: true },
  { id: 34, label: "Address 2 (Optional)", property: "FromStreet2", required: false },
  { id: 35, label: "Zip Code", property: "FromZip", required: true, regEx: String(zipCodeRegex).slice(1, -1) },
  ...
  { id: 39, label: "Phone Number (Optional)", property: "FromPhone", required: false, regEx: String(phoneNumberRegex).slice(1, -1) },
  { id: 41, label: "Name", property: "ToName", required: true },
  { id: 42, label: "Company Name (Optional)", property: "ToCompany", required: false },
  { id: 43, label: "Address", property: "ToStreet1", required: true },
  { id: 44, label: "Address 2 (Optional)", property: "ToStreet2", required: false },
  { id: 45, label: "Zip Code", property: "ToZip", required: true, regEx: String(zipCodeRegex).slice(1, -1) },
  ...
  { id: 49, label: "Phone Number (Optional)", property: "ToPhone", required: false, regEx: String(phoneNumberRegex).slice(1, -1) },
