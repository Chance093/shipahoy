  ...
  return (
    <main className="ml-72 flex flex-col gap-8 px-10 py-10">
      ...
      <section className="flex gap-8">
        <section className="bg-radial-gradient before:bg-linear-gradient relative flex  h-48 max-w-xs flex-1 flex-col justify-between rounded-2xl  p-5 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:-z-10 before:h-[194px] before:w-[322px] before:-translate-x-[1px] before:-translate-y-[1px] before:rounded-2xl before:content-['']">
          <p>Labels</p>
