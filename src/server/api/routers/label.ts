  ...
  createLabel: protectedProcedure
    .input(
      z.object({
        ...
        fromPhoneNumber: z.string().trim().regex(phoneNumberRegex, { message: "Must enter valid phone number" }),
        ...
        toPhoneNumber: z.string().trim().regex(phoneNumberRegex, { message: "Must enter valid phone number" }),
